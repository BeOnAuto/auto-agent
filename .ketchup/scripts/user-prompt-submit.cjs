...
${error.message}`;
    ...
    function resolveTsConfig(directory) {
      ...
      if (filePath !== void 0) {
        const { config, error } = typescript.readConfigFile(filePath, (path7) => typescript.sys.readFile(path7));
        if (error) {
...
var require_util = __commonJS({
  "node_modules/.pnpm/cosmiconfig@9.0.0_typescript@5.9.3/node_modules/cosmiconfig/dist/util.js"(exports2) {
    ...
    async function isDirectory(path7) {
      try {
        const stat = await fs_1.promises.stat(path7);
    ...
    function isDirectorySync(path7) {
      try {
        const stat = fs_1.default.statSync(path7);
        return stat.isDirectory();
      } catch (e) {
        if (e.code === "ENOENT") {
          return false;
...
${[...importStack, fullPath].map((path7, i) => `${i + 1}. ${path7}`).join("\n")} (same as ${idx + 1}.)`);
          }
        }
      }
  ...
  "node_modules/.pnpm/cosmiconfig@9.0.0_typescript@5.9.3/node_modules/cosmiconfig/dist/Explorer.js"(exports2) {
    ...
    var Explorer = class extends ExplorerBase_js_1.ExplorerBase {
      ...
      async #fileExists(path7) {
        try {
          await promises_1.default.stat(path7);
          return true;
        } catch (e) {
          return false;
        }
...
var require_dist = __commonJS({
  "node_modules/.pnpm/cosmiconfig@9.0.0_typescript@5.9.3/node_modules/cosmiconfig/dist/index.js"(exports2) {
    ...
    function getResolvedSearchPlaces(moduleName, toolDefinedSearchPlaces, userConfiguredOptions) {
      const userConfiguredSearchPlaces = userConfiguredOptions.searchPlaces?.map((path7) => path7.replace("{name}", moduleName));
...
async function handleUserPromptSubmit(claudeDir2, sessionId, userPrompt) {
