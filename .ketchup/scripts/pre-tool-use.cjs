...
${error.message}`;
    ...
    function resolveTsConfig(directory) {
      ...
      if (filePath !== void 0) {
        const { config, error } = typescript.readConfigFile(filePath, (path10) => typescript.sys.readFile(path10));
        if (error) {
...
var require_util = __commonJS({
  "node_modules/.pnpm/cosmiconfig@9.0.0_typescript@5.9.3/node_modules/cosmiconfig/dist/util.js"(exports2) {
    ...
    function getPropertyByPath(source, path10) {
      if (typeof path10 === "string" && Object.prototype.hasOwnProperty.call(source, path10)) {
        return source[path10];
      }
...
function spawnAsync(cmd, args, _options) {
  return new Promise((resolve2, reject) => {
    const child = (0, import_node_child_process.spawn)(cmd, args, { stdio: ["ignore", "pipe", "pipe"] });
    let stdout = "";
    let stderr = "";
