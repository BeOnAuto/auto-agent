...
>({
  ...
  events: [
    { name: 'ServerImplemented', displayName: 'Server Implemented' },
    { name: 'ServerImplementationFailed', displayName: 'Server Implementation Failed' },
  ],
  handle: async (
