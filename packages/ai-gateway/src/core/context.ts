...
function createProviderModel(provider: AIProvider, modelName: string, context: AIContext): LanguageModel {
...
export function getModel(provider: AIProvider, model: string | undefined, context: AIContext): LanguageModel {
