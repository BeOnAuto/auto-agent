# Ketchup Plan: Fix Generated Server Code Failures
...
- [x] Burst 2: Fix annotateEventSources + react templates for unknown event sources (64d263bd)
- [x] Burst 3: Fix query action detection in projection.specs.ts.ejs for normalized specs (c31f6fde)
