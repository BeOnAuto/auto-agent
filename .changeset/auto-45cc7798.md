...
- Added extraction of events and states from given references in server generator
- Improved filtering to exclude phantom references that don't correspond to actual event labels
