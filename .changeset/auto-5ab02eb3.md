...
- Fixed message extraction for react patterns to correctly handle when/then ordering
- Normalized react entries before extraction so messages match the generated template output
- Preserved source slice name tracking through the normalization pipeline
