...
- Added normalization for Pattern B-full Given/When/Then slices so trigger events are correctly placed in the "when" position
- Templates now receive a consistent Pattern A format regardless of the original narrative pattern used
