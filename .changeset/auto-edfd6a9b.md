...
- Fixed a bug where the original when-command was lost during react pattern normalization, ensuring generated server code correctly preserves command references
