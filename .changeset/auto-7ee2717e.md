...
- Added nesting-aware inline object field parser that correctly handles nested types like Array<{...}>
- Fixed field parsing for float detection to use the new depth-tracking parser instead of naive comma/semicolon splitting
