...
- Added state context information to generated server implementation instructions, helping the AI implementer know which database states are available to read from
